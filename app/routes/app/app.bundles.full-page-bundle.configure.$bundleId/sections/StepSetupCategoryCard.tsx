  ...
  return (
    <>
      <div className={fullPageBundleStyles.card}>
        ...
        {((step.StepCategory as any[] | undefined) ?? []).map(
            ...
            return (
              <div
                ...
                onDrop={(e: React.DragEvent) =>
                  handleCatDrop(e, step.id, catKey)
                }
              >
                <div
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        ).filter((_: any, i: number) => i !== catIndex);
                  ...
                  <button
                    ...
                    aria-label={
                      isOpen ? "Collapse category" : "Expand category"
                    }
                  ...
                  <div className={fullPageBundleStyles.categoryAccordionBody}>
                    <div className={fullPageBundleStyles.categoryFieldGroup}>
                      ...
                      <div className={fullPageBundleStyles.catNameRow}>
                        <div
                          className={fullPageBundleStyles.categoryInputStack}
                        >
                          <input
                    ...
                    {catActiveTab === 0 && (
                      <div>
                        ...
                        {catProducts.length > 0 && (
                          <div
                            className={fullPageBundleStyles.categoryProductList}
                          >
                            {catProducts.map((product: any) => (
                              <div
                                key={product.id}
                                className={
                                  fullPageBundleStyles.categoryProductRow
                                }
                              >
                                <img
                                  className={
                                    fullPageBundleStyles.categoryProductImage
                                  }
                                ...
                                <span
                                  className={
                                    fullPageBundleStyles.categoryProductTitle
                                  }
                                >
                                  {product.title}
                                </span>
                                <button
                                  type="button"
                                  className={
                                    fullPageBundleStyles.categoryDangerButton
                                  }
                                  onClick={() => {
                                    const updated = (
                                      (step.StepCategory as any[]) ?? []
                    ...
                    {catActiveTab === 1 && (
                      <div>
                        <p className={fullPageBundleStyles.categoryPickerHelp}>
                          Collections selected here will be displayed on this
                          step
                        </p>
                        <div className={fullPageBundleStyles.productActions}>
                          <s-button
