...
**REFERENCE:** See `AGENTS.md` in project root for full guidelines
...
AGENTS.md                    # Guidelines (project root)
```
...
**For project guidelines:** Read `AGENTS.md` in project root
