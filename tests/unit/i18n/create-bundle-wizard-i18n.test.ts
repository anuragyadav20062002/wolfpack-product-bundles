...
const requiredKeys = [
  ...
  "createBundle.fields.description",
  "createBundle.fields.descriptionPlaceholder",
  "createBundle.bundleType.heading",
  "createBundle.bundleType.productPage.title",
  "createBundle.bundleType.productPage.description",
  "createBundle.bundleType.productPage.alt",
  "createBundle.bundleType.fullPage.title",
  "createBundle.bundleType.fullPage.description",
  "createBundle.bundleType.fullPage.alt",
