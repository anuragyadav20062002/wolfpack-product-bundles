...
| 13 | Standard mobile footer contract | 390px mobile viewport | Footer is a fixed/sticky 370px white tray, discount area above a 360px x 38px black `Next • total` button with 5px radius | Captured from live EB Standard mobile footer |
