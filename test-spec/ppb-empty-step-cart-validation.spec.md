...
| 3 | Step-validation helper is used by product-page widget modules | Product-page widget build list | Helper module is inlined before dependent method modules | Prevents live bundle ReferenceError |
