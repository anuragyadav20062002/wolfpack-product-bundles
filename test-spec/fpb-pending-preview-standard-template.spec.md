...
|---|---|---|---|---|
| 1 | Full-page bundle has no saved template fields | `bundleType=full_page`, `bundleDesignTemplate=null`, `bundleDesignPresetId=null` | Formatter emits `FBP_SIDE_FOOTER` and `STANDARD` | Keeps `data-bundle-config` accepted by widget cache path |
