...
|---|---|---|---|---|
| 1 | Discounted bundle parent line | `_is_bundle_parent=true`, aggregate retail/bundle/savings attributes | Renders `Bundle Savings`, `Retail Price:`, `Bundle Price:`, `Savings:`, and `% Saved:` | `% Saved` is computed from savings divided by retail |
