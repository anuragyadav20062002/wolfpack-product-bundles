...
**Spec ID:** fpb-horizontal-design-storefront  **Issue:** [fpb-template-deep-parity-audit-1]  **Created:** 2026-06-04
...
| 5 | Horizontal product image fit | Desktop and mobile product images | Product image CSS uses `object-fit: cover` in runtime and static template CSS | Corrected from fresh EB computed styles |
