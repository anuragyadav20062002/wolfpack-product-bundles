...
| 4 | Preset isolation | `bundle-widget-full-page.js` | COMPACT runtime selectors remain scoped and do not override DEFAULT, CLASSIC, or HORIZONTAL selectors | Prevents preset regression |
