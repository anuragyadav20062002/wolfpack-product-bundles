...
| 4 | Tier action buttons match footer treatment | Inspect Add Tier Rule and Add Add Ons Tier | Buttons use Polaris secondary button path | No custom CSS button path |
