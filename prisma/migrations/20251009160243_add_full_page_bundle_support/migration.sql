...
INSERT INTO "new_BundleStep" ("bundleId", "collections", "conditionOperator", "conditionType", "conditionValue", "createdAt", "displayVariantsAsIndividual", "enabled", "icon", "id", "maxQuantity", "minQuantity", "name", "position", "productCategory", "products", "updatedAt") SELECT "bundleId", "collections", "conditionOperator", "conditionType", "conditionValue", "createdAt", "displayVariantsAsIndividual", "enabled", "icon", "id", "maxQuantity", "minQuantity", "name", "position", "productCategory", "products", "updatedAt" FROM "BundleStep";
