...
was re-accepted through HS19 on widget 5.0.166. Product Grid was re-accepted
through PG08 on the hot-reloaded dev widget 5.0.167. Vertical Slots must still
be re-audited and cannot inherit the earlier acceptance claims below.
...
| Vertical Slots accepted | Pending | Prior VS00-VS03 acceptance is superseded until the new live re-audit completes. |
