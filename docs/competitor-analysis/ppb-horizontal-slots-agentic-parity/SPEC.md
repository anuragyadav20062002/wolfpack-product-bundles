...
| HS02 product cards | EB card grid, sale/compare-at pairs, and square/tall/wide sources captured | Equivalent responsive grid, compare-at hierarchy, and mixed-ratio containment captured | Proxy key and missing authenticated setting control fixed; currency/source dimensions differ | Accepted baseline, compare-at, and mixed media; missing-image fallback remains open |
