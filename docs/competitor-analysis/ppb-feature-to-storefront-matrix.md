...
| C13 | Display quantity input setting | Quantity input visibility follows the global PPB control | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` |
| C14 | See-more / expanded card setting | Long content behavior follows `displaySeeMoreLink` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` |
| C15 | Product-card hover expansion | `expandProductCardOnHover` behavior | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` | **S** Shared source coverage in `ppb-product-page-card-controls.test.ts` |
...
| D09 | Discount message variables and custom copy | Remaining quantity/amount, value/unit, discounted items | **S** Shared PPB footer and modal variable pipelines now resolve rule-aware placeholders via TemplateManager; unit tests added in `ppb-product-page-footer-discount-messaging-toggle.test.ts` and `ppb-product-page-modal-accessibility.test.ts`. Visual parity replay pending. | **S** Shared PPB footer and modal variable pipelines now resolve rule-aware placeholders via TemplateManager; unit tests added in `ppb-product-page-footer-discount-messaging-toggle.test.ts` and `ppb-product-page-modal-accessibility.test.ts`. Visual parity replay pending. | **S** Shared PPB footer and modal variable pipelines now resolve rule-aware placeholders via TemplateManager; unit tests added in `ppb-product-page-footer-discount-messaging-toggle.test.ts` and `ppb-product-page-modal-accessibility.test.ts`. Visual parity replay pending (template-specific text rendering variants still pending). | **S** Shared PPB footer and modal variable pipelines now resolve rule-aware placeholders via TemplateManager; unit tests added in `ppb-product-page-footer-discount-messaging-toggle.test.ts` and `ppb-product-page-modal-accessibility.test.ts`. Visual parity replay pending. |
| D10 | Progress bar off / simple / step-based | Each saved display mode renders independently | **S** Source-level mode-aware renderer now branches `simple`/`step_based` and emits milestones in the footer path (`ppb-product-page-footer-discount-messaging-toggle.test.ts`, `ppb-product-page-discount-config.spec.md`). Visual parity replay pending per template. | **S** Source-level mode-aware renderer now branches `simple`/`step_based` and emits milestones in the footer path (`ppb-product-page-footer-discount-messaging-toggle.test.ts`, `ppb-product-page-discount-config.spec.md`). Visual parity replay pending per template. | **S** Source-level mode-aware renderer now branches `simple`/`step_based` and emits milestones in the footer path (`ppb-product-page-footer-discount-messaging-toggle.test.ts`, `ppb-product-page-discount-config.spec.md`). Visual parity replay pending per template. | **S** Source-level mode-aware renderer now branches `simple`/`step_based` and emits milestones in the footer path (`ppb-product-page-footer-discount-messaging-toggle.test.ts`, `ppb-product-page-discount-config.spec.md`). Visual parity replay pending per template. |
...
| D12 | Multi-language discount/progress labels | Active locale selects the correct saved copy | **S** Shared locale-resolution source path now routes through `TemplateManager.getDiscountMessageTemplate(..., locale)` with `ruleMessagesByLocale` and fallback in `ppb-product-page-footer-discount-messaging-toggle.test.ts`; modal locale path covered in `ppb-product-page-modal-accessibility.test.ts`. Visual parity replay pending. | **S** Shared locale-resolution source path now routes through `TemplateManager.getDiscountMessageTemplate(..., locale)` with `ruleMessagesByLocale` and fallback in `ppb-product-page-footer-discount-messaging-toggle.test.ts`; modal locale path covered in `ppb-product-page-modal-accessibility.test.ts`. Visual parity replay pending. | **S** Shared locale-resolution source path now routes through `TemplateManager.getDiscountMessageTemplate(..., locale)` with `ruleMessagesByLocale` and fallback in `ppb-product-page-footer-discount-messaging-toggle.test.ts`; modal locale path covered in `ppb-product-page-modal-accessibility.test.ts`. Visual parity replay pending. | **S** Shared locale-resolution source path now routes through `TemplateManager.getDiscountMessageTemplate(..., locale)` with `ruleMessagesByLocale` and fallback in `ppb-product-page-footer-discount-messaging-toggle.test.ts`; modal locale path covered in `ppb-product-page-modal-accessibility.test.ts`. Visual parity replay pending. |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Product List | 40 | 22 | 43 | 2 | 0 | 12 |
| Product Grid | 35 | 23 | 49 | 0 | 0 | 12 |
| Horizontal Slots | 51 | 18 | 46 | 0 | 3 | 1 |
| Vertical Slots | 37 | 27 | 52 | 0 | 2 | 1 |
