...
| G02 | Add Browsed Product / preselection | Browsed product is preselected when eligible | **X** [G02 add-browsed preselection divergence evidence](ppb-deferred-functional-parity/G02-add-browsed-product-preselection-divergence-evidence.md) | **X** [G02 add-browsed preselection divergence evidence](ppb-deferred-functional-parity/G02-add-browsed-product-preselection-divergence-evidence.md) | **X** [G02 add-browsed preselection divergence evidence](ppb-deferred-functional-parity/G02-add-browsed-product-preselection-divergence-evidence.md) | **X** [G02 add-browsed preselection divergence evidence](ppb-deferred-functional-parity/G02-add-browsed-product-preselection-divergence-evidence.md) |
...
| G22 | Track inventory on Add To Cart | Cart-time inventory validation follows the saved control | **P** [G22 inventory-on-add evidence](ppb-deferred-functional-parity/G22-track-inventory-on-add-to-cart-evidence.md) | **P** [G22 inventory-on-add evidence](ppb-deferred-functional-parity/G22-track-inventory-on-add-to-cart-evidence.md) | **P** [G22 inventory-on-add evidence](ppb-deferred-functional-parity/G22-track-inventory-on-add-to-cart-evidence.md) | **P** [G22 inventory-on-add evidence](ppb-deferred-functional-parity/G22-track-inventory-on-add-to-cart-evidence.md) |
...
| G24 | Redirect Collection Quick Add to Bundle | Theme quick-add enters the correct PPB offer/context | **X** [G24 collection quick-add divergence evidence](ppb-deferred-functional-parity/G24-collection-quick-add-redirect-divergence-evidence.md) | **X** [G24 collection quick-add divergence evidence](ppb-deferred-functional-parity/G24-collection-quick-add-redirect-divergence-evidence.md) | **X** [G24 collection quick-add divergence evidence](ppb-deferred-functional-parity/G24-collection-quick-add-redirect-divergence-evidence.md) | **X** [G24 collection quick-add divergence evidence](ppb-deferred-functional-parity/G24-collection-quick-add-redirect-divergence-evidence.md) |
...
| G27 | Redirect settings | Default side-cart update, checkout redirect, and cart redirect follow the saved mode | **P** [G27 redirect settings evidence](ppb-deferred-functional-parity/G27-redirect-settings-evidence.md) | **P** [G27 redirect settings evidence](ppb-deferred-functional-parity/G27-redirect-settings-evidence.md) | **P** [G27 redirect settings evidence](ppb-deferred-functional-parity/G27-redirect-settings-evidence.md) | **P** [G27 redirect settings evidence](ppb-deferred-functional-parity/G27-redirect-settings-evidence.md) |
