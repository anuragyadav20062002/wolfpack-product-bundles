...
| S09 | Successful cart add | Valid child selection reaches the expected cart result | **P** PL08 | **P** [S09-S13 Product Grid cart contract](ppb-deferred-functional-parity/S09-S13-product-grid-cart-contract-evidence.md) | **P** HS08 | **S** Shared PPB cart path only |
...
| S11 | Child properties and parent transform | Offer ID, component data, parent line, and visible metadata match EB semantics | **P** PL08 | **P** [S09-S13 Product Grid cart contract](ppb-deferred-functional-parity/S09-S13-product-grid-cart-contract-evidence.md) | **P** HS08 | **S** HS shared contract only |
| S12 | `bundle_details` accumulation | Shopify cart metafield records the resulting bundle | **P** PL08 | **P** [S09-S13 Product Grid cart contract](ppb-deferred-functional-parity/S09-S13-product-grid-cart-contract-evidence.md) | **P** HS08 | **S** HS shared contract only |
| S13 | Discount transform proof | Cart price/allocation agrees with displayed discount | **P** PL08 | **P** [S09-S13 Product Grid cart contract](ppb-deferred-functional-parity/S09-S13-product-grid-cart-contract-evidence.md) | **P** HS08 | **S** HS shared contract only |
