...
| G20 | Pricing configuration | Displayed original/savings/total fields follow saved visibility/copy | **T** | **P** [G20 Product Grid pricing evidence](ppb-deferred-functional-parity/G20-product-grid-pricing-configuration-evidence.md) | **T** | **T** |
