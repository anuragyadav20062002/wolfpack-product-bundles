...
| S10 | Blocked cart add | Invalid selection cannot create a cart mutation | **P** PL02/PL08 | **S** Intermediate validation proven, cart mutation not isolated | **P** HS08/HS10 | **P** [S09-S13 Vertical Slots cart contract](ppb-deferred-functional-parity/S09-S13-vertical-slots-cart-contract-evidence.md) |
