...
| Filled rows, media, text, long titles | Proven | VS02 proves 64px rows, 50px media, full CSS-contained titles, dynamic capacity, desktop/mobile parity. |
| Picker structure and product cards | Proven | VS03 plus shared HS01/HS02/HS03/HS04/HS18 evidence; Vertical invokes the same live bottom-sheet picker. |
...
| CTA, discounts, totals, validation | Proven | VS03 proves 5%/10% totals and exact-one validation; HS06/HSS4 cover shared zero/no-discount states. |
...
| Cross-template leakage | Proven | Final live four-template sweep and 25-suite focused pass. |
