...
| Field | Value |
|---|---|
| Status | wpb-variants-individual-proofed-eb-individual-open |
...
- [ ] Variants-as-individual-products state is captured for EB and WPB. WPB is proofed on `5.0.22`; EB individual proof remains open.
