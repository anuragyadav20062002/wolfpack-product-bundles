...
## Phases Checklist
- [ ] Priority 1: Migrate cart transform target
- [ ] Priority 2a: Delete/deprecate CART_TRANSFORM_FUNCTION.md
- [ ] Priority 2b: Fix API_ENDPOINTS.md rate limit
- [ ] Priority 2c: Update APPLICATION_ARCHITECTURE.md
- [ ] Priority 3: Re-run semantic extraction chunks 05, 08–23
- [ ] Priority 3: Rebuild graph + Obsidian vault after extraction
